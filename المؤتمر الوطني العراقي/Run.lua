...
{text = '⓺', callback_data="/help6@"..data.sender_user_id_},{text = '⓻', callback_data="/help7@"..data.sender_user_id_},
	  ...
	  answerCallbackQuery(data.id_,'قائمة الاوامر ليست لك', true)
		...
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/inc/Run.lua','./inc/Run.lua')
		EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/inc/locks.lua','./inc/locks.lua')
		EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/inc/Script.lua','./inc/Script.lua')
		EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/inc/functions.lua','./inc/functions.lua')
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
		download_file('https://raw.githubusercontent.com/Fawaz859/MAX/master/plugins/games.lua','./plugins/games.lua')
