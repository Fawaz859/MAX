...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/Fawaz859/max.github.io/GetVersion.txt') or 0
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فواز يرجى كلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@SOURCE_FAWAZ"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : مـاكـس](t.me/@SOURCE_FAWAZ)',nil,inline,msg.id_)
return false
end
...
return [[
🧚🏻‍♀️ ⇜ اهلا وسهلا بك بسورس فواز
🧚🏻‍♀️ ⇜ [قناه السورس](https://t.me/Source_Fawaz)
🧚🏻‍♀️ ⇜ [مطور السورس](https://t.me/wtttw)
...
"احجي بسرعه شتريد 😤","ها يا قلبي ❤️","هم صاحو عليه راح ابدل اسمي من وراكم 😡",
...
"طالع مموجود 😒","هااا شنوو اكو حاته بالقروب وصحت عليه  😍💕","انت مو قبل يومين غلطت عليه؟  😒",
...
"موجوع قلبي😔والتعب بية☹️من اباوع على روحي😢ينكسر قلبي عليه😭",
...
elseif Text== "حسن" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/WtttW")
elseif Text== "حسن العراقي" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس فواز 😍](t.me/WtttW")
...
elseif Text== "شكو ماكو"  then return sendMsg(msg.chat_id_,msg.id_,"غيرك/ج بل كلب ماكو يبعد قلبي😍❤️️")
...
elseif Text== "عضه"  then return sendMsg(msg.chat_id_,msg.id_,"شكلولك علي كلب؟ انته روح عضه 😕😹" )
...
elseif Text== "فديت" or Text=="فطيت" then return sendMsg(msg.chat_id_,msg.id_,"فداك/ج قلبي ودكاته 🙈💗")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/SOURCE_FAWAZ)
]] )
--=====================================
elseif Text== "انجب" or Text== "نجب" or Text=="جب" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"عشانك مطور بمشيها عشانك")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"على راسي يالمنشئ")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"رافعك مدير وتهايط؟ بتصير عضو واوريك")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"مرفوع ادمن ومسوي فيها؟ بتصير عضو ياهطف")
else 
return sendMsg(msg.chat_id_,msg.id_,"احترم نفسك")
end 
end 
